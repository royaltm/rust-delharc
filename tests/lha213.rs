...
const TESTS_CASES: &[(u64, &str, &str, u64, u64, u16, u32, &str, u8, CompressionMethod)] = &[
    (0x664, "sfx.exe", "GPL-2",      7004,   18092, 0xA33A, 0x4E46F4A1, "2010-01-01 00:00:00", 0, CompressionMethod::Lh5),
    ...
    (0, "lh5_long.lzh", "LONG.TXT",  84000, 1241658, 0x6a7c, 0x06788E85, "2011-12-11 21:30:14", 1, CompressionMethod::Lh5),
    (0, "subdir.lzh",
