...
const TESTS_CASES: &[(&str, &str, u64, u64, u16, u32, &str, u8, CompressionMethod, &str, &str)] = &[
    ("h0_lh0.lzh", "gpl2.gz",  6829,  6829, 0xB6D5, 0xE4690583, "2012-09-22 15:57:00", 0, Lh0, "-rw--w--w-", "---w--wr"),
    #[cfg(feature = "lh1")]
    ("h0_lh1.lzh", "gpl2",     7514, 18092, 0xA33A, 0x4E46F4A1, "1980-01-01 00:00:02", 0, Lh1, "-rw-r-xr-x", "--e-r-wr"),
    ("h0_subdir.lzh",
        "SUBDIR*SUBDIR2*hello.txt", 12, 12, 0x9778, 0xAF083B2D, "2012-09-22 15:59:00", 0, Lh0, "-rw-r--r--", "----r-wr"),
    ("h1_lh0.lzh", "gpl2.gz",  6829,  6829, 0xB6D5, 0xE4690583, "2012-09-22 15:57:00", 1, Lh0, "-rw--w--w-", "---w--wr"),
    #[cfg(feature = "lh1")]
    ("h1_lh1.lzh", "gpl2",     7514, 18092, 0xA33A, 0x4E46F4A1, "1980-01-01 00:00:02", 1, Lh1, "-rw-r-xr-x", "--e-r-wr"),
    ("h1_subdir.lzh",
        "SUBDIR*SUBDIR2*hello.txt", 12, 12, 0x9778, 0xAF083B2D, "2012-09-22 15:59:00", 1, Lh0, "-rw-r--r--", "----r-wr"),
    ("h2_lh0.lzh", "gpl2.gz",  6829,  6829, 0xB6D5, 0xE4690583, "2012-09-22 20:57:01 UTC", 2, Lh0, "-rw--w--w-", "---w--wr"),
    #[cfg(feature = "lh1")]
    ("h2_lh1.lzh", "gpl2",     7514, 18092, 0xA33A, 0x4E46F4A1, "1970-01-01 00:00:58 UTC", 2, Lh1, "-rw-r-xr-x", "--e-r-wr"),
    ("h2_subdir.lzh",
        "SUBDIR*SUBDIR2*hello.txt", 12, 12, 0x9778, 0xAF083B2D, "2012-09-22 20:59:01 UTC", 2, Lh0, "-rw-r--r--", "----r-wr"),
];

#[test]
fn test_lha_os9_211c() -> io::Result<()> {
    for (name, path, size_c, size_o, crc16, crc32, modif, level, compr, perm, attr) in TESTS_CASES {
        println!("-------------\n{:?}", name);
        ...
        for filen in 0.. {
            ...
            assert_eq!(os9perm.to_string(), *attr);
            assert_eq!(Permissions::from(os9perm).to_string(), *perm);
